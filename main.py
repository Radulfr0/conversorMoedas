...
janela.iconbitmap("icons8-dinheiro-16.ico")
...
botao_converter = customtkinter.CTkButton(janela, text="Converter", command=converter_moeda, font=("",20))

lista_moedas = customtkinter.CTkScrollableFrame(janela)

texto_cotacao_moeda = customtkinter.CTkLabel(janela, text="", font=("",20), text_color="#006000")
